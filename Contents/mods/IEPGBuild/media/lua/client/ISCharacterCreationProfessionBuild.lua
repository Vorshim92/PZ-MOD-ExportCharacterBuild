...
local originalCreate = CharacterCreationProfession.create
...
function CharacterCreationProfession:create()
    ...
    self.importBuildButton = ISButton:new(self.saveBuildButton:getRight() + 10, self.saveBuildButton:getY(), 50, buttonHgt, getText("UI_characreation_BuildImport"), self, CharacterCreationProfession.importBuild)
    ...
    self.exportBuildButton = ISButton:new(self.importBuildButton:getRight() + 10, self.importBuildButton:getY(), 50, buttonHgt, getText("UI_characreation_BuildExport"), self, CharacterCreationProfession.exportBuild)
...
local originalUpdate = CharacterCreationProfession.update
...
function CharacterCreationProfession:importBuild()
...
function CharacterCreationProfession:processImportCode(code)
    ...
    -- Expected format: "BuildName:profession;trait1;trait2;trait3;..."
    ...
    if string.find(code, ":") then
        ...
        -- Just a list of traits, assign default name
        buildData = code
...
-- Show import result
function CharacterCreationProfession:showImportResult(success, message)
...
-- Add the export function with properly implemented RichTextPanel and centered button
function CharacterCreationProfession:exportBuild()
